...
const workshops = [
...

  {
    ...
    docsURL: 'https://salesforce.quip.com/9SU2A3GlVCaN',
    launchURL: plat_launcher + 'https://github.com/chadevanssf/df19-flow-allonboard',
...

  {
    ...
    docsURL: 'https://salesforce.quip.com/9SU2A3GlVCaN',
    launchURL: plat_launcher + 'https://github.com/chadevanssf/df19-flow-consentcapture',
...

  {
    ...
    docsURL: 'https://salesforce.quip.com/9SU2A3GlVCaN',
    launchURL: plat_launcher + 'https://github.com/chadevanssf/df19-flow-changemanagement',
